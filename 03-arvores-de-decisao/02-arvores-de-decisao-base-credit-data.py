...
precisao = accuracy_score(classe_teste, previsoes) # Percentual de acertos (acurácia)
print(precisao)
matriz = confusion_matrix(classe_teste, previsoes) # Matriz de confusão, contendo os registros onde ocorrem os erros e acertos
print(matriz)